...
<!-- [[[cog
    ...
    def dynamic_badge(url, query, **kwargs):
        qargs = {
            "url": url,
            "query": query,
            "label": kwargs.pop("label"),
        }
        return badge(url="/badge/dynamic/json", qargs=qargs, **kwargs)
...
<!-- [[[cog
    ...
    def write_package(pkg, human, repo, mastinfo=None):
        ...
        if mastinfo is not None:
            print('  ', badge_mastodon(*mastinfo), sep='')
]]] -->
<!-- [[[end]]] -->
...
*(made with [cog](https://github.com/nedbat/cog) at 2024-09-14 12:45 UTC)*
<!-- [[[end]]] -->
